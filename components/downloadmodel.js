      ...
      <div className="modal-card">
        <header className="modal-card-head">
          <p class="modal-card-title">
            {isAppleShown ? "What about iOS?" : "Download"}
          </p>
          <button
            className="delete"
            aria-label="close"
        ...
        <section className="modal-card-body">
          <div
            style={{ display: !isAppleShown ? "block" : "none" }}
            className="buttons"
          >
            <IconButton
              ...
              icon={["fas", "globe-asia"]}
            >
              Download Web App (Desktop & Android)
            </IconButton>
            <IconButton
              href="https://play.google.com/store/apps/details?id=org.hackesta.tweet2pic"
